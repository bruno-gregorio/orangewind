...
<div class="grid min-w-0 gap-3 overflow-x-auto rounded border border-ow-surface-border p-8">
  <div class="ow-code-snippet ow-is-bordered min-w-0">
    ...
    <pre class="ow-code-snippet-block-icon"><code
        >sudo snap install thunderbird --channel=latest/stable</code
      ></pre>
  </div>
</div>

<p>
  A code snippet presents commands, output or source in a contained block with
  an optional <code>ow-code-snippet-header</code> for a title and actions.
  Choose a block class to suit the content: a plain
  <code>ow-code-snippet-block</code>, a prompt
  <code>ow-code-snippet-block-icon</code> or a line-numbered
  <code>ow-code-snippet-block-numbered</code>.
</p>

<h2 id="default" class="ow-heading-2">Default with copy</h2>
<p>
  The header holds an <code>ow-code-snippet-title</code> and an
  <code>ow-code-snippet-actions</code> group. The copy button reuses the base
  button styles via <code>ow-code-snippet-copy</code>. A leading-prompt block
  uses <code>ow-code-snippet-block-icon</code>.
</p>
<Example
  block
  code={`<div class="ow-code-snippet">
  <div class="ow-code-snippet-header">
    <h5 class="ow-code-snippet-title">Install Thunderbird as a snap</h5>
    <div class="ow-code-snippet-actions">
...
<h2 id="icon-variants" class="ow-heading-2">Prompt icons</h2>
<p>
  <code>ow-code-snippet-block-icon</code> shows a Linux prompt by default. Add
  <code>ow-is-windows-prompt</code> for a Windows command prompt or
  <code>ow-is-url</code> to mark the line as a link.
</p>
<Example
  block
  code={`<div class="ow-code-snippet">
...
<h2 id="numbered" class="ow-heading-2">Numbered</h2>
<p>
  <code>ow-code-snippet-block-numbered</code> renders a line gutter. Wrap each
...
<span class="ow-code-snippet-line">set -eu</span>
<span class="ow-code-snippet-line">snap refresh --hold=24h</span></code
      ></pre>
  </div>
</Example>

<h2 id="wrapped" class="ow-heading-2">Wrapped</h2>
<p>
  Long single-line commands overflow horizontally by default. Add
  <code>ow-is-wrapped</code> to the block to wrap them instead.
</p>
<Example
  block
  code={`<div class="ow-code-snippet">
...
>
  <div class="ow-code-snippet">
    <pre class="ow-code-snippet-block ow-is-wrapped"><code
        >microk8s kubectl create secret generic image-pull-secret --from-file=.dockerconfigjson=/home/ubuntu/.docker/config.json</code
      ></pre>
  </div>
</Example>

<h2 id="dropdowns" class="ow-heading-2">Header dropdowns</h2>
<p>
  Swap the actions for an <code>ow-code-snippet-dropdowns</code> group of
  <code>ow-code-snippet-dropdown</code> selects to let users choose a variant of
...
<h2 id="bordered" class="ow-heading-2">Bordered</h2>
<p>
  Add <code>ow-is-bordered</code> to outline the whole snippet, which suits showing
  source above its rendered result.
</p>
<Example
  block
  code={`<div class="ow-code-snippet ow-is-bordered">
  <div class="ow-code-snippet-header">
