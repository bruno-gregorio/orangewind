...
<p>
  Breadcrumbs show the user's location within the site hierarchy and let them
...
<p>
  Use an ordered list of <code>ow-breadcrumbs-item</code> elements. Each step except
  the current page is a link; the final item is plain text marking the page the user
  is on.
</p>
<Example
  code={`<nav class="ow-breadcrumbs" aria-label="Breadcrumb">
  <ol class="ow-breadcrumbs-list">
    <li class="ow-breadcrumbs-item"><a href="/overview">Overview</a></li>
    <li class="ow-breadcrumbs-item"><a href="/features">Features</a></li>
    <li class="ow-breadcrumbs-item"><a href="/managed">Managed</a></li>
...
<h2 id="single-level" class="ow-heading-2">Single level</h2>
<p>
  A shallow trail can be just one link back to the parent followed by the
  current page.
</p>
<Example
  code={`<nav class="ow-breadcrumbs" aria-label="Breadcrumb">
...
<h2 id="long-labels" class="ow-heading-2">Long labels</h2>
<p>
  Separators are positioned in CSS, so longer labels wrap naturally inside the
  trail without breaking the layout.
</p>
<Example
  code={`<nav class="ow-breadcrumbs" aria-label="Breadcrumb">
  <ol class="ow-breadcrumbs-list">
