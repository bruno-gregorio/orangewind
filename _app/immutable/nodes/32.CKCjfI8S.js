import{a as l,f as s}from"../chunks/BloWK6qd.js";import"../chunks/Nz-WpKIz.js";import{s as i,f as g}from"../chunks/Cjeq8u6e.js";import{E as o}from"../chunks/CZfo3WOY.js";var f=s('<ul class="ow-list"><li class="ow-list-item">Community</li> <li class="ow-list-item">Careers</li> <li class="ow-list-item">Press centre</li></ul>'),b=s('<ul class="ow-list"><li class="ow-list-item ow-is-ticked">Hardware guidance and sizing</li> <li class="ow-list-item ow-has-bullet">Deployment automation</li> <li class="ow-list-item ow-is-crossed">24 x 7 support</li></ul>'),v=s('<ol class="ow-list-divided"><li class="ow-list-item">Bootstrap the controller</li> <li class="ow-list-item">Add the model</li> <li class="ow-list-item">Register credentials</li> <li class="ow-list-item">Start the deployment</li></ol>'),k=s('<ul class="ow-inline-list-middot"><li class="ow-inline-list-item">Community</li> <li class="ow-inline-list-item">Careers</li> <li class="ow-inline-list-item">Press centre</li> <li class="ow-inline-list-item">Contact</li></ul>'),y=s('<ol class="ow-list-nested-counter"><li>Install the base system</li> <li>Choose the deployment target <ol><li>Ubuntu Server</li> <li>MAAS image stream</li></ol></li> <li>Proceed with the relevant install steps</li></ol>'),$=s(`<ol class="ow-stepped-list"><li class="ow-stepped-list-item"><h2 class="ow-stepped-list-title ow-heading-2">Create a model</h2> <p class="ow-stepped-list-content">Create the model and confirm operators can reach the controller.</p></li> <li class="ow-stepped-list-item"><h2 class="ow-stepped-list-title ow-heading-2">Deploy charms</h2> <p class="ow-stepped-list-content">Add the charms that make up the workload and expose only what needs
