import{a as s,f as a}from"../chunks/BloWK6qd.js";import"../chunks/Nz-WpKIz.js";import{p as v,s as o,f,t as y,a as S,c as $,n as r,r as x}from"../chunks/Cjeq8u6e.js";import{s as T}from"../chunks/BXUcxCK4.js";import{i as _,w as k}from"../chunks/Dq1V-0Y1.js";import{E as n}from"../chunks/CZfo3WOY.js";var O=a('<div class="grid gap-2"><button class="ow-btn-positive">Save</button></div>'),C=a('<button class="ow-btn">Default</button> <button class="ow-btn ow-is-small">Small</button> <button class="ow-btn ow-is-small ow-is-dense">Small + dense</button>',1),E=a('<div class="ow-notification-positive"><div class="ow-notification-content"><span class="ow-notification-title">Saved</span> <span class="ow-notification-message">Your changes are live.</span></div></div>'),P=a('<div class="flex flex-wrap items-center gap-3"><button class="ow-btn-positive">Save</button> <button class="ow-btn-base">Cancel</button></div>'),B=a('<button class="ow-btn-positive ow-is-small">Save</button>'),M=a(`<p>Orangewind is a class-based framework: you write plain HTML and apply
