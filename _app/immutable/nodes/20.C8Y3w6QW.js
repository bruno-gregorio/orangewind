import{a as p,f as w}from"../chunks/BrLxys79.js";import{e as $,f as q,t as m,c as s,s as i,r as u}from"../chunks/DAFKDzfT.js";import{d as D}from"../chunks/xUn5-6LJ.js";import{s as l}from"../chunks/CrM5BQoy.js";import{E as g}from"../chunks/5gGF761m.js";var C=w('<div class="grid min-h-56 content-start"><span class="ow-contextual-menu"><button type="button" class="ow-btn ow-contextual-menu-toggle" aria-controls="right-menu" aria-haspopup="true">Align right</button> <span class="ow-contextual-menu-dropdown" id="right-menu"><span class="ow-contextual-menu-group"><button type="button" class="ow-contextual-menu-link">Commission</button> <button type="button" class="ow-contextual-menu-link">Acquire</button> <button type="button" class="ow-contextual-menu-link">Deploy</button></span></span></span></div>'),T=w('<div class="grid min-h-56 content-start"><span class="ow-contextual-menu-left"><button type="button" class="ow-btn ow-contextual-menu-toggle" aria-controls="left-menu" aria-haspopup="true">Align left</button> <span class="ow-contextual-menu-dropdown" id="left-menu"><span class="ow-contextual-menu-group"><button type="button" class="ow-contextual-menu-link">Commission</button> <button type="button" class="ow-contextual-menu-link">Acquire</button> <button type="button" class="ow-contextual-menu-link">Deploy</button></span></span></span></div>'),E=w('<div class="grid min-h-56 content-start"><span class="ow-contextual-menu-left"><button type="button" class="ow-btn-positive ow-contextual-menu-toggle ow-has-icon" aria-controls="indicator-menu" aria-haspopup="true"><span>Take action</span> <i class="ow-icon-chevron-down ow-contextual-menu-indicator" aria-hidden="true"></i></button> <span class="ow-contextual-menu-dropdown" id="indicator-menu"><span class="ow-contextual-menu-group"><a href="#commission" class="ow-contextual-menu-link">Commission</a> <a href="#acquire" class="ow-contextual-menu-link">Acquire</a> <a href="#deploy" class="ow-contextual-menu-link">Deploy</a></span></span></span></div>'),P=w(`<div class="grid min-h-72 place-items-start rounded border border-ow-surface-border p-8"><span class="ow-contextual-menu-left"><button type="button" class="ow-btn ow-contextual-menu-toggle" aria-controls="headline-menu" aria-haspopup="true">Take action…</button> <span class="ow-contextual-menu-dropdown" id="headline-menu"><span class="ow-contextual-menu-group"><button type="button" class="ow-contextual-menu-link">Commission</button> <button type="button" class="ow-contextual-menu-link">Acquire</button> <button type="button" class="ow-contextual-menu-link">Deploy</button></span> <span class="ow-contextual-menu-group"><button type="button" class="ow-contextual-menu-link">Rescue mode</button> <button type="button" class="ow-contextual-menu-link">Mark broken</button></span></span></span></div> <p>A contextual menu reveals a dropdown of related actions from a toggle button.
