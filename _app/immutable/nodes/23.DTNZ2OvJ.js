import{a as d,f as l}from"../chunks/DLhIqdvp.js";import{p as E,s as i,f as I,a as C,c as a,h as v,t as N,g as h,b as A,r as s}from"../chunks/Cjeq8u6e.js";import{d as L}from"../chunks/BYU81E74.js";import{c as w,s as p}from"../chunks/BH4sgpHL.js";import{E as m}from"../chunks/CDnnywVE.js";var R=l('<div class="ow-docs grid w-full grid-cols-2 gap-2 [&amp;>*]:rounded [&amp;>*]:border [&amp;>*]:border-ow-surface-border [&amp;>*]:p-3"><header class="ow-docs-header col-span-2 font-medium">ow-docs-header</header> <aside class="ow-docs-sidebar opacity-75">ow-docs-sidebar</aside> <div class="ow-docs-title font-medium">ow-docs-title</div> <div class="ow-docs-meta opacity-75">ow-docs-meta</div> <div class="ow-docs-main opacity-75">ow-docs-main</div> <footer class="ow-docs-footer col-span-2 opacity-75">ow-docs-footer</footer></div>'),q=l(`<pre class="m-0 overflow-x-auto text-sm"><code>.ow-docs &lbrace;
  grid-template-areas:
    'header  header'
    'sidebar title'
    'sidebar meta'
