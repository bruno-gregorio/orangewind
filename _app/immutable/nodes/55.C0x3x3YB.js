import{a as r,f as s}from"../chunks/DLhIqdvp.js";import"../chunks/Nz-WpKIz.js";import{p as y,s as e,f as x,t as T,a as _,c as O,n as S,r as $}from"../chunks/Cjeq8u6e.js";import{s as C}from"../chunks/BXUcxCK4.js";import{i as V,w as B}from"../chunks/kHub54fw.js";import{E as d}from"../chunks/CDnnywVE.js";import{C as t}from"../chunks/D_adwx9w.js";var E=s(`<div class="bg-ow-background-alt text-ow-text-default w-full rounded border border-ow-surface-border p-4">Surface painted from Orangewind's theme tokens.</div>`),F=s('<div class="grid w-full gap-3 sm:grid-cols-2 lg:grid-cols-4"><div class="ow-card">One</div> <div class="ow-card">Two</div> <div class="ow-card">Three</div> <div class="ow-card">Four</div></div>'),P=s('<div class="grid w-full gap-3"><button class="ow-btn-positive">Save</button> <button class="ow-btn-base">Cancel</button></div>'),q=s(`<p>Orangewind layers component classes on top of Tailwind v4 and leans on
  ...
  it.</p>`,1);function U(f,b){y(b,!1),V();var n=q(),i=e(x(n),6);t(i,{lang:"css",code:`@theme {
...
</div>`,children:(o,u)=>{var a=E();r(o,a)},$$slots:{default:!0}});var l=e(c,8);t(l,{lang:"css",code:`:root {
  @variant dark {
...
}`});var p=e(l,4);t(p,{lang:"css",code:`@import 'tailwindcss';
@import 'orangewind';

/* drive dark mode from a class instead of the OS preference */
@custom-variant dark (&:where(.dark, .dark *));`});var h=e(p,4);t(h,{lang:"css",code:`:root {
  color-scheme: light dark;
}`});var m=e(h,6);t(m,{lang:"css",code:`@theme {
...
</div>`,children:(o,u)=>{var a=F();r(o,a)},$$slots:{default:!0}});var g=e(w,6);d(g,{block:!0,code:`<!-- prefer: the parent owns the rhythm via gap -->
<div class="grid gap-3">
  <button class="ow-btn-positive">Save</button>
  <button class="ow-btn-base">Cancel</button>
</div>`,children:(o,u)=>{var a=P();r(o,a)},$$slots:{default:!0}});var v=e(g,8),k=e(O(v),5);S(),$(v),T(o=>C(k,"href",o),[()=>B("/docs/components/links")]),r(f,n),_()}export{U as component};
